...
int main(void)
{
    ...
    //  xTaskCreate(task100, "t100", 512, NULL, 6, NULL);
    //  xTaskCreate(task200, "t200", 512, NULL, 5, NULL);
    //  xTaskCreate(task500, "t500", 512, NULL, 4, NULL);
    xTaskCreate(task1000, "t1000", 512, NULL, 3, NULL);
    xTaskCreate(task5000, "t5000", 512, NULL, 2, NULL);
    xTaskCreate(task10000, "t10000", 512, NULL, 1, NULL);
